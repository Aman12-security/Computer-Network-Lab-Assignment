...
Enabled only ICMP in filters
Used Add Simple PDU for packet generation
Used Capture/Forward to observe flow
Simulated errors by deleting packets in Event List
---
🟡 6. Stop-and-Wait ARQ
🔹 Implementation
...
Enable ICMP filter
Use Add Simple PDU to send packets
Use Capture/Forward to observe
Delete packets to simulate errors
---
📁 15. Files Included
`stop_and_wait.pkt`
`go_back_n_arq.pkt`
